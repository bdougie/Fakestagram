...
//  Fakestagram
//
//  Created by Brian Douglas on 8/28/15.
...
@property (nonatomic, strong) FilterCollectionViewCell *filterView;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UICollectionViewFlowLayout* layout = (UICollectionViewFlowLayout*) self.filterCollectionView.collectionViewLayout;
    [cell layoutWithEdgeSize: layout.itemSize.width];
